...
python3 run_on_env.py --config-name=eval_libero env.load_dir=/root/bet/exp_local/2025.04.08/071421_libero_train
# python3 train.py --config-name=train_libero student_type=iterativerandom seed=2 project=neurips25_libero batch_size=64
python3 run_on_env.py --config-name=eval_libero env.load_dir=/root/bet/exp_local/2025.04.08/112002_libero_train
# python3 train.py --config-name=train_libero student_type=iterativerandom seed=3 project=neurips25_libero batch_size=64
python3 run_on_env.py --config-name=eval_libero env.load_dir=/root/bet/exp_local/2025.04.08/153528_libero_train
# python3 train.py --config-name=train_libero student_type=iterativerandom seed=4 project=neurips25_libero batch_size=64
python3 run_on_env.py --config-name=eval_libero env.load_dir=/root/bet/exp_local/2025.04.08/193540_libero_train
